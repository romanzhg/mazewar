...
/* data structures for toplevel.cpp */
typedef struct {
	Loc *x;
	Loc *y;
	Direction *dir;
...
#define PACKET_STATE 0x01
#define PACKET_USERNAME_REQ 0x10
#define PACKET_USERNAME_ACK 0x11
#define PACKET_TAGGED 0x20
#define PACKET_TAGGED_ACK 0x21
#define PACKET_LEAVE 0x30
...
// ack is set to short for easy manipulation
typedef struct {
        unsigned short guid;
        unsigned short ack;
        unsigned int tagKey;
...
/* headers from toplevel.cpp */
//void processSTATE(MW244BPacket * );
void sendState();
